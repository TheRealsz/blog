        ...
        <DialogContent className="w-10/12 bg-dark-20 border-none rounded-lg gap-8 py-10">
            ...
            <div className="flex flex-col items-center w-full gap-6">
                ...
                <form className="flex w-11/12 flex-col gap-6 md:w-9/12" onSubmit={handleSubmit(handleEditProfile)}>
                    ...
                    <button disabled={isLoading} type="submit" className="w-full font-medium flex items-center justify-center gap-2 bg-main-500 py-2 rounded-md text-white hover:bg-main-600 transition-all outline-none 2xl:text-lg disabled:opacity-60">
