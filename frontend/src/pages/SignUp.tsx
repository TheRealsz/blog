                        ...
                        <form className="w-full flex" name="SignUpForm" ref={ref} onSubmit={handleSignUp}>
                            <div className="w-full flex flex-col gap-4">
                                <div className='w-full flex flex-col'>
                                    ...
                                    <input required name="fullname" type="text" placeholder="Insira seu nome completo" className='px-3 py-1.5 rounded-md border-gray-300 border-solid border focus:border-violet-600 outline-none 2xl:py-2' />
                                </div>
                                <div className='w-full flex flex-col'>
