    ...
    <div className="w-11/12 flex flex-col items-center gap-8 sm:w-6/12 md:w-5/12 lg:w-10/12 xl:w-8/12 2xl:w-7/12 2xl:mr-60">
      ...
      <div className="flex flex-col justify-center gap-4">
        <div className="text-center flex flex-col gap-1 xl:text-left">
          <h1 className="text-xl font-bold 2xl:text-2xl">Bem vindo ao TheReal!</h1>
          <p className="text-black/70 2xl:text-lg">Faça o login ou cadastre-se para saber de tudo sobre o mundo da tecnologia e da programação em nossos site</p>
        </div>
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className='w-full flex flex-col'>
              ...
              <div className="flex justify-end pt-1">
                <a className="text-primary text-sm 2xl:text-base">Esqueceu a senha?</a>
              </div>
            </div>
          </div>
          <div className="w-full">
            <button className="w-full bg-primary text-white py-2.5 rounded font-semibold 2xl:text-lg">Entrar</button>
          </div>
        </form>
      </div>
